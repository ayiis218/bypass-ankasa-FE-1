...
const formFlight = ({ data, childCount, adultCount, userInfo }) => {
   ...
   const notification = (data, item) => {
      const starCountRef = ref(
         database,
         `notification/${userInfo?.user_id}/${new Date().getTime()}`
      );
      set(starCountRef, {
         ...
         axios
            ...
            .then((res) => {
               ...
               Swal.fire({
                  ...
                  result.isConfirmed ? router.push('/') : null
               );
               setIsLoading(false);
            })
            .catch((err) => {
  ...
  console.log("data", data); */
   ...
   const currency = price.format(totalPrice());
                           ...
                           <div className={style.result}>
                              <div className="row mt-3 ms-1">
                                 ...
                                 <div className="col-5">
                                    <div className="me-3">
                                       <h2
                                          className={`d-flex justify-content-end ${style.city}`}
                                       >
                                          {item.destination}
                                       </h2>
